...
namespace Web.Models
{
	public partial class NeedPpeTypeViewModel : IValidatableObject
	{
		...
		public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
		{
			...
			if(Type.IsOther() && Selected && String.IsNullOrWhiteSpace(PpeTypeOther))
			{
				respVal.Add(new ValidationResult("Please add <b>Other description</b> to describe the PPE Type when choosing <b>\"Other...\"</b>", 
