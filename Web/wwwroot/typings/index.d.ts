...
declare namespace Noty {
    ...
    type Theme = 'mint' | 'sunset' | 'relax' | 'metroui' | 'light' | 'bootstrap-v3' | 'bootstrap-v4' | 'semanticui' | 'nest';
    ...
    interface IAnimationBcs {
        open?: string | null | Function,
        close?: string | null | Function
    }

    interface ICallbacksBcs {
            beforeShow?: () => void,
            onShow?: () => void,
            afterShow?: () => void,
            onClose?: () => void,
