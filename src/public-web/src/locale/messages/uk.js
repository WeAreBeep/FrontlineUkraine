export default {
  ...
  landing_welcome_banner_message: 'Щоб захистити користувачів, лише перевірені користувачі можуть переглядати детальні дані. Ця загальнодоступна карта показує зведені дані в масштабі міста. Щоб стати підтвердженим користувачем, заповніть {a, react, href{/register-supplies} children{У МЕНЕ Є форму}} (постачальники) або {a, react, href{/register-needs} children{МЕНІ ПОТРІБНО форма}} (зареєстровані організації допомоги).',
  ...
  i_need_form_sub_form_how_many_you_need_title:
    'Виберіть кількість. Хоча ми робимо все можливе, щоб задовольнити ваші запити, зверніть увагу, що деякі потреби можуть покриватися поступово.',
